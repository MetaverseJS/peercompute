...
const ESHKOL_PRODUCTION_HANDLER_IMPLEMENTATION_SCHEMA =
...
function normalizeEshkolFullPhysicsValidationRequirements(requirements = null) {
  const source = objectOrNull(requirements);
...
function createFullPhysicsValidationRequirementsFromSummaryFields(summary = {}) {
  const schema = firstPresent(
    summary.eshkolFullPhysicsValidationRequirementsSchema,
    summary.closureFullPhysicsValidationRequirementsSchema,
    summary.fullPhysicsValidationRequirementsSchema
  );
  const status = firstPresent(
    summary.eshkolFullPhysicsValidationRequirementsStatus,
    summary.closureFullPhysicsValidationRequirementsStatus,
    summary.fullPhysicsValidationRequirementsStatus
  );
  const requiredRuntimeEvidenceFamilies = firstPresent(
    summary.eshkolFullPhysicsValidationRequiredRuntimeEvidenceFamilies,
    summary.closureFullPhysicsValidationRequiredRuntimeEvidenceFamilies,
    summary.fullPhysicsValidationRequiredRuntimeEvidenceFamilies
  );
  const requiredHashFields = firstPresent(
    summary.eshkolFullPhysicsValidationRequiredHashFields,
    summary.closureFullPhysicsValidationRequiredHashFields,
    summary.fullPhysicsValidationRequiredHashFields
  );
  ...
  return {
    ...
    status,
    ready: firstPresent(
      summary.eshkolFullPhysicsValidationRequirementsReady,
      summary.closureFullPhysicsValidationRequirementsReady,
      summary.fullPhysicsValidationRequirementsReady
    ),
    validationScope: firstPresent(
      summary.eshkolFullPhysicsValidationRequirementsValidationScope,
      summary.closureFullPhysicsValidationRequirementsValidationScope,
      summary.fullPhysicsValidationRequirementsValidationScope
    ),
    producerSchema: firstPresent(
      summary.eshkolFullPhysicsValidationRequirementsProducerSchema,
      summary.closureFullPhysicsValidationRequirementsProducerSchema,
      summary.fullPhysicsValidationRequirementsProducerSchema
    ),
    requiredValidationSchema: firstPresent(
      summary.eshkolFullPhysicsValidationRequirementsRequiredValidationSchema,
      summary.closureFullPhysicsValidationRequirementsRequiredValidationSchema,
      summary.fullPhysicsValidationRequirementsRequiredValidationSchema
    ),
    requiredValidationScope: firstPresent(
      summary.eshkolFullPhysicsValidationRequirementsRequiredValidationScope,
      summary.closureFullPhysicsValidationRequirementsRequiredValidationScope,
      summary.fullPhysicsValidationRequirementsRequiredValidationScope
    ),
    requiredRuntimeEvidenceFamilies,
    requiredHashFields,
    requiredRuntimeEvidence: firstPresent(
      summary.eshkolFullPhysicsValidationRequiredRuntimeEvidence,
      summary.closureFullPhysicsValidationRequiredRuntimeEvidence,
      summary.fullPhysicsValidationRequiredRuntimeEvidence
    ),
    blockedBy: firstPresent(
      summary.eshkolFullPhysicsValidationRequirementsBlockedBy,
      summary.closureFullPhysicsValidationRequirementsBlockedBy,
      summary.fullPhysicsValidationRequirementsBlockedBy
    )
  };
}
...
function createBoundaryFromSummaryFields(summary = {}) {
  ...
  const fullPhysicsValidationRequirements = normalizeEshkolFullPhysicsValidationRequirements(
    createFullPhysicsValidationRequirementsFromSummaryFields(summary)
  );
  return {
    ...
    productionHandlerContractHandlerId:
      summary.eshkolProductionHandlerContractHandlerId
      || summary.closureProductionHandlerContractHandlerId
      || null,
    productionHandlerContractDispatchSchema:
      summary.eshkolProductionHandlerContractDispatchSchema
      || summary.closureProductionHandlerContractDispatchSchema
      || null,
    productionHandlerContractEntryExport:
      summary.eshkolProductionHandlerContractEntryExport
      || summary.closureProductionHandlerContractEntryExport
      || null,
    productionHandlerContractRuntimeAbi:
      summary.eshkolProductionHandlerContractRuntimeAbi
      || summary.closureProductionHandlerContractRuntimeAbi
      || null,
    productionHandlerContractTensorMemoryModel:
      summary.eshkolProductionHandlerContractTensorMemoryModel
      || summary.closureProductionHandlerContractTensorMemoryModel
      || null,
    productionHandlerContractInputTensorIds:
      summary.eshkolProductionHandlerContractInputTensorIds
      || summary.closureProductionHandlerContractInputTensorIds
      || [],
    productionHandlerContractOutputTensorIds:
      summary.eshkolProductionHandlerContractOutputTensorIds
      || summary.closureProductionHandlerContractOutputTensorIds
      || [],
    productionHandlerContractInvocationModuleSource:
      summary.eshkolProductionHandlerContractInvocationModuleSource
      || summary.closureProductionHandlerContractInvocationModuleSource
      || null,
    productionHandlerContractInvocationEntryExport:
      summary.eshkolProductionHandlerContractInvocationEntryExport
      || summary.closureProductionHandlerContractInvocationEntryExport
      || null,
    ...
    productionHandlerContractInvocationInputOffsetParam:
      summary.eshkolProductionHandlerContractInvocationInputOffsetParam
      ?? summary.closureProductionHandlerContractInvocationInputOffsetParam
      ?? null,
    productionHandlerContractInvocationOutputOffsetParam:
      summary.eshkolProductionHandlerContractInvocationOutputOffsetParam
      ?? summary.closureProductionHandlerContractInvocationOutputOffsetParam
      ?? null,
    productionHandlerContractInvocationExpectedReturn:
      summary.eshkolProductionHandlerContractInvocationExpectedReturn
      ?? summary.closureProductionHandlerContractInvocationExpectedReturn
      ?? null,
    productionHandlerContractRequiredEvidence:
      summary.eshkolProductionHandlerContractRequiredEvidence
    ...
    productionHandlerImplementationSchema:
      summary.eshkolProductionHandlerImplementationSchema
      || summary.closureProductionHandlerImplementationSchema
      || null,
    productionHandlerImplementationStatus:
      summary.eshkolProductionHandlerImplementationStatus
      || summary.closureProductionHandlerImplementationStatus
      || null,
    productionHandlerImplementationReady:
      summary.eshkolProductionHandlerImplementationReady
      ?? summary.closureProductionHandlerImplementationReady
      ?? null,
    productionHandlerImplementationScope:
      summary.eshkolProductionHandlerImplementationScope
      || summary.closureProductionHandlerImplementationScope
      || null,
    productionHandlerImplementationExecutionClaim:
      summary.eshkolProductionHandlerImplementationExecutionClaim
      || summary.closureProductionHandlerImplementationExecutionClaim
      || null,
    productionHandlerImplementationEvidence:
      summary.eshkolProductionHandlerImplementationEvidence
      || summary.closureProductionHandlerImplementationEvidence
      || [],
    productionHandlerImplementationEvidenceCount:
      summary.eshkolProductionHandlerImplementationEvidenceCount
      ?? summary.closureProductionHandlerImplementationEvidenceCount
      ?? null,
    productionHandlerImplementationBlockedBy:
      summary.eshkolProductionHandlerImplementationBlockedBy
      || summary.closureProductionHandlerImplementationBlockedBy
      || [],
    productionHandlerRuntimeExecutionSchema:
      summary.eshkolProductionHandlerRuntimeExecutionSchema
      || summary.closureProductionHandlerRuntimeExecutionSchema
      || null,
    productionHandlerRuntimeExecutionStatus:
      summary.eshkolProductionHandlerRuntimeExecutionStatus
      || summary.closureProductionHandlerRuntimeExecutionStatus
      || null,
    productionHandlerRuntimeExecutionReady:
      summary.eshkolProductionHandlerRuntimeExecutionReady
      ?? summary.closureProductionHandlerRuntimeExecutionReady
      ?? null,
    productionHandlerRuntimeExecutionEntryArgs:
      summary.eshkolProductionHandlerRuntimeExecutionEntryArgs
    ...
    productionHandlerRuntimeExecutionHostImportCallCounts:
      summary.eshkolProductionHandlerRuntimeExecutionHostImportCallCounts
      || summary.closureProductionHandlerRuntimeExecutionHostImportCallCounts
      || null,
    productionHandlerRuntimeExecutionBlockedBy:
      summary.eshkolProductionHandlerRuntimeExecutionBlockedBy
      || summary.closureProductionHandlerRuntimeExecutionBlockedBy
      || [],
...
function normalizeEshkolProductionHandlerBoundary(boundary = null) {
  ...
  const productionHandlerContract = objectOrNull(boundary.productionHandlerContract) || {};
  const productionHandlerContractInvocation = objectOrNull(productionHandlerContract.invocation) || {};
  const productionHandlerImplementation = objectOrNull(boundary.productionHandlerImplementation) || {
  ...
  const productionHandlerRuntimeExecution = objectOrNull(boundary.productionHandlerRuntimeExecution) || {
  ...
  const productionHandlerRuntimeExecutionHostImportCallCounts =
    objectOrNull(productionHandlerRuntimeExecution.hostImportCallCounts)
    || objectOrNull(boundary.productionHandlerRuntimeExecutionHostImportCallCounts)
    || null;
  ...
  const fullPhysicsValidationRequirements = normalizeEshkolFullPhysicsValidationRequirements(
    objectOrNull(boundary.fullPhysicsValidationRequirements) || {
  ...
  return {
    ...
    productionHandlerContractInputTensorIds:
      uniqueStrings(productionHandlerContractInputTensorIds || []),
    productionHandlerContractOutputTensorIds:
      uniqueStrings(productionHandlerContractOutputTensorIds || []),
    productionHandlerContractInvocationModuleSource:
      stringOrNull(
    ...
    productionHandlerContractInvocationParameterTypes:
      orderedStrings(productionHandlerContractInvocationParameterTypes || []),
    productionHandlerContractInvocationResultTypes:
      orderedStrings(productionHandlerContractInvocationResultTypes || []),
    productionHandlerContractInvocationInputOffsetParam:
      finiteNumberOrNull(
    ...
    productionHandlerContractRequiredEvidence:
      uniqueStrings(productionHandlerContractRequiredEvidence || []),
    productionHandlerContractRequiredEvidenceCount:
      finiteNumberOrNull(
        boundary.productionHandlerContractRequiredEvidenceCount
        ?? uniqueStrings(productionHandlerContractRequiredEvidence || []).length
      ),
    productionHandlerContractBlockedBy:
      uniqueStrings(productionHandlerContractBlockedBy || []),
    ...
    productionHandlerImplementationEvidence:
      uniqueStrings(productionHandlerImplementationEvidence || []),
    productionHandlerImplementationEvidenceCount:
      finiteNumberOrNull(
        boundary.productionHandlerImplementationEvidenceCount
        ?? uniqueStrings(productionHandlerImplementationEvidence || []).length
      ),
    productionHandlerImplementationBlockedBy:
      uniqueStrings(productionHandlerImplementationBlockedBy || []),
    ...
    productionHandlerRuntimeExecutionBlockedBy:
      uniqueStrings(productionHandlerRuntimeExecutionBlockedBy || []),
    fullPhysicsValidationRequirements: clonePlain(fullPhysicsValidationRequirements),
    fullPhysicsValidationRequirementsSchema:
      fullPhysicsValidationRequirements?.schema || null,
    fullPhysicsValidationRequirementsStatus:
...
function createEshkolIngestSummary(payload = {}, probe = null) {
  ...
  const fullPhysicsValidationRequirements = normalizeEshkolFullPhysicsValidationRequirements(
    createFullPhysicsValidationRequirementsFromSummaryFields(summary)
    || probe?.descriptorProbe?.productionHandlerBoundary?.fullPhysicsValidationRequirements
  );
  return {
    ...
    eshkolProductionHandlerContractSchema:
      summary.eshkolProductionHandlerContractSchema
      || summary.closureProductionHandlerContractSchema
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractSchema
      || null,
    eshkolProductionHandlerContractStatus:
      summary.eshkolProductionHandlerContractStatus
      || summary.closureProductionHandlerContractStatus
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractStatus
      || null,
    eshkolProductionHandlerContractDeclared:
      summary.eshkolProductionHandlerContractDeclared
      ?? summary.closureProductionHandlerContractDeclared
      ?? probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractDeclared
      ?? null,
    eshkolProductionHandlerContractHandlerId:
      summary.eshkolProductionHandlerContractHandlerId
      || summary.closureProductionHandlerContractHandlerId
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractHandlerId
      || null,
    eshkolProductionHandlerContractDispatchSchema:
      summary.eshkolProductionHandlerContractDispatchSchema
      || summary.closureProductionHandlerContractDispatchSchema
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractDispatchSchema
      || null,
    eshkolProductionHandlerContractEntryExport:
      summary.eshkolProductionHandlerContractEntryExport
      || summary.closureProductionHandlerContractEntryExport
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractEntryExport
      || null,
    eshkolProductionHandlerContractRuntimeAbi:
      summary.eshkolProductionHandlerContractRuntimeAbi
      || summary.closureProductionHandlerContractRuntimeAbi
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractRuntimeAbi
      || null,
    eshkolProductionHandlerContractTensorMemoryModel:
      summary.eshkolProductionHandlerContractTensorMemoryModel
      || summary.closureProductionHandlerContractTensorMemoryModel
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractTensorMemoryModel
      || null,
    eshkolProductionHandlerContractInputTensorIds:
      clonePlain(summary.eshkolProductionHandlerContractInputTensorIds
        || summary.closureProductionHandlerContractInputTensorIds
        || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractInputTensorIds
        || []),
    eshkolProductionHandlerContractOutputTensorIds:
      clonePlain(summary.eshkolProductionHandlerContractOutputTensorIds
        || summary.closureProductionHandlerContractOutputTensorIds
        || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractOutputTensorIds
        || []),
    eshkolProductionHandlerContractInvocationModuleSource:
      summary.eshkolProductionHandlerContractInvocationModuleSource
      || summary.closureProductionHandlerContractInvocationModuleSource
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractInvocationModuleSource
      || null,
    eshkolProductionHandlerContractInvocationEntryExport:
      summary.eshkolProductionHandlerContractInvocationEntryExport
      || summary.closureProductionHandlerContractInvocationEntryExport
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractInvocationEntryExport
      || null,
    eshkolProductionHandlerContractInvocationArgumentMode:
      summary.eshkolProductionHandlerContractInvocationArgumentMode
      || summary.closureProductionHandlerContractInvocationArgumentMode
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractInvocationArgumentMode
      || null,
    eshkolProductionHandlerContractInvocationParameterTypes:
      clonePlain(summary.eshkolProductionHandlerContractInvocationParameterTypes
        || summary.closureProductionHandlerContractInvocationParameterTypes
        || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractInvocationParameterTypes
        || []),
    eshkolProductionHandlerContractInvocationResultTypes:
      clonePlain(summary.eshkolProductionHandlerContractInvocationResultTypes
        || summary.closureProductionHandlerContractInvocationResultTypes
        || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractInvocationResultTypes
        || []),
    eshkolProductionHandlerContractInvocationInputOffsetParam:
      summary.eshkolProductionHandlerContractInvocationInputOffsetParam
      ?? summary.closureProductionHandlerContractInvocationInputOffsetParam
      ?? probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractInvocationInputOffsetParam
      ?? null,
    eshkolProductionHandlerContractInvocationOutputOffsetParam:
      summary.eshkolProductionHandlerContractInvocationOutputOffsetParam
      ?? summary.closureProductionHandlerContractInvocationOutputOffsetParam
      ?? probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractInvocationOutputOffsetParam
      ?? null,
    eshkolProductionHandlerContractInvocationExpectedReturn:
      summary.eshkolProductionHandlerContractInvocationExpectedReturn
      ?? summary.closureProductionHandlerContractInvocationExpectedReturn
      ?? probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractInvocationExpectedReturn
      ?? null,
    eshkolProductionHandlerContractRequiredEvidence:
      clonePlain(summary.eshkolProductionHandlerContractRequiredEvidence
        || summary.closureProductionHandlerContractRequiredEvidence
        || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractRequiredEvidence
        || []),
    eshkolProductionHandlerContractRequiredEvidenceCount:
      summary.eshkolProductionHandlerContractRequiredEvidenceCount
      ?? summary.closureProductionHandlerContractRequiredEvidenceCount
      ?? probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractRequiredEvidenceCount
      ?? null,
    eshkolProductionHandlerContractBlockedBy:
      clonePlain(summary.eshkolProductionHandlerContractBlockedBy
        || summary.closureProductionHandlerContractBlockedBy
        || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerContractBlockedBy
        || []),
    eshkolProductionHandlerImplementationSchema:
      summary.eshkolProductionHandlerImplementationSchema
      || summary.closureProductionHandlerImplementationSchema
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerImplementationSchema
      || null,
    eshkolProductionHandlerImplementationStatus:
      summary.eshkolProductionHandlerImplementationStatus
      || summary.closureProductionHandlerImplementationStatus
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerImplementationStatus
      || null,
    eshkolProductionHandlerImplementationReady:
      summary.eshkolProductionHandlerImplementationReady
      ?? summary.closureProductionHandlerImplementationReady
      ?? probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerImplementationReady
      ?? null,
    eshkolProductionHandlerImplementationEvidenceCount:
      summary.eshkolProductionHandlerImplementationEvidenceCount
      ?? summary.closureProductionHandlerImplementationEvidenceCount
      ?? probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerImplementationEvidenceCount
      ?? null,
    eshkolProductionHandlerImplementationBlockedBy:
      clonePlain(summary.eshkolProductionHandlerImplementationBlockedBy
        || summary.closureProductionHandlerImplementationBlockedBy
        || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerImplementationBlockedBy
        || []),
    eshkolProductionHandlerRuntimeExecutionSchema:
      summary.eshkolProductionHandlerRuntimeExecutionSchema
      || summary.closureProductionHandlerRuntimeExecutionSchema
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerRuntimeExecutionSchema
      || null,
    eshkolProductionHandlerRuntimeExecutionStatus:
      summary.eshkolProductionHandlerRuntimeExecutionStatus
      || summary.closureProductionHandlerRuntimeExecutionStatus
      || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerRuntimeExecutionStatus
      || null,
    eshkolProductionHandlerRuntimeExecutionReady:
      summary.eshkolProductionHandlerRuntimeExecutionReady
      ?? summary.closureProductionHandlerRuntimeExecutionReady
      ?? probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerRuntimeExecutionReady
      ?? null,
    eshkolProductionHandlerRuntimeExecutionEntryArgs:
      clonePlain(summary.eshkolProductionHandlerRuntimeExecutionEntryArgs
        || summary.closureProductionHandlerRuntimeExecutionEntryArgs
    ...
    eshkolProductionHandlerRuntimeExecutionHostImportCallCounts:
      clonePlain(summary.eshkolProductionHandlerRuntimeExecutionHostImportCallCounts
        || summary.closureProductionHandlerRuntimeExecutionHostImportCallCounts
        || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerRuntimeExecutionHostImportCallCounts
        || null),
    eshkolProductionHandlerRuntimeExecutionBlockedBy:
      clonePlain(summary.eshkolProductionHandlerRuntimeExecutionBlockedBy
        || summary.closureProductionHandlerRuntimeExecutionBlockedBy
        || probe?.descriptorProbe?.productionHandlerBoundary?.productionHandlerRuntimeExecutionBlockedBy
        || []),
    ...
    eshkolFullPhysicsValidationRequirementsDeclared:
      summary.eshkolFullPhysicsValidationRequirementsDeclared
      ?? summary.closureFullPhysicsValidationRequirementsDeclared
    ...
    eshkolFullPhysicsValidationRequiredRuntimeEvidenceFamilies:
      clonePlain(summary.eshkolFullPhysicsValidationRequiredRuntimeEvidenceFamilies
        || summary.closureFullPhysicsValidationRequiredRuntimeEvidenceFamilies
    ...
    eshkolFullPhysicsValidationRequiredRuntimeEvidenceSchemas:
      clonePlain(summary.eshkolFullPhysicsValidationRequiredRuntimeEvidenceSchemas
        || fullPhysicsValidationRequirements?.requiredRuntimeEvidenceSchemas
        || []),
    eshkolFullPhysicsValidationRequiredRuntimeEvidenceCount:
      summary.eshkolFullPhysicsValidationRequiredRuntimeEvidenceCount
      ?? summary.closureFullPhysicsValidationRequiredRuntimeEvidenceCount
      ?? fullPhysicsValidationRequirements?.requiredRuntimeEvidenceCount
      ?? null,
    eshkolFullPhysicsValidationRequiredHashFields:
      clonePlain(summary.eshkolFullPhysicsValidationRequiredHashFields
        || summary.closureFullPhysicsValidationRequiredHashFields
        || fullPhysicsValidationRequirements?.requiredHashFields
        || []),
    eshkolFullPhysicsValidationRequiredRuntimeEvidence:
      clonePlain(summary.eshkolFullPhysicsValidationRequiredRuntimeEvidence
        || summary.closureFullPhysicsValidationRequiredRuntimeEvidence
        || fullPhysicsValidationRequirements?.requiredRuntimeEvidence
        || []),
    eshkolFullPhysicsValidationRequirementsBlockedBy:
      clonePlain(summary.eshkolFullPhysicsValidationRequirementsBlockedBy
        || summary.closureFullPhysicsValidationRequirementsBlockedBy
