...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/constants.js
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/crypto/js.js
var pureJsCrypto = {
  hashSHA256(data) {
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/crypto/index.browser.js
var defaultCrypto = pureJsCrypto;

// ../../peercompute/node_modules/@libp2p/noise/dist/src/crypto.js
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/encoder.js
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/metrics.js
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/logger.js
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/errors.js
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/nonce.js
var MIN_NONCE = 0;
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/protocol.js
var ZEROLEN = alloc(0);
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/proto/payload.js
var NoiseExtensions;
    ...
    if (_codec == null) {
      _codec = message((obj, w, opts = {}) => {
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            case 1: {
              if (((_a3 = opts.limits) == null ? void 0 : _a3.webtransportCerthashes) != null && obj.webtransportCerthashes.length === opts.limits.webtransportCerthashes) {
            ...
            case 2: {
              if (((_b3 = opts.limits) == null ? void 0 : _b3.streamMuxers) != null && obj.streamMuxers.length === opts.limits.streamMuxers) {
          ...
          switch (tag >>> 3) {
            ...
            case 4: {
              obj.extensions = NoiseExtensions.codec().decode(reader, reader.uint32(), {
                limits: (_a3 = opts.limits) == null ? void 0 : _a3.extensions
              });
              break;
            }
            default: {
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/utils.js
...
var EncryptedMessageStream = class extends AbstractMessageStream {
  ...
  encrypt(chunk) {
    ...
    for (let i = 0; i < chunk.byteLength; i += NOISE_MSG_MAX_LENGTH_BYTES_WITHOUT_TAG) {
      ...
      (_a3 = this.metrics) == null ? void 0 : _a3.encryptedPackets.increment();
  ...
  decrypt(chunk) {
    ...
    for (let i = 0; i < chunk.byteLength; i += NOISE_MSG_MAX_LENGTH_BYTES) {
      ...
      try {
        ...
        (_a3 = this.metrics) == null ? void 0 : _a3.decryptedPackets.increment();
        output.append(plaintext);
      } catch (e) {
        (_b3 = this.metrics) == null ? void 0 : _b3.decryptErrors.increment();
        throw e;
      }
    }
    return output;
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/performHandshake.js
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/noise.js
var _a2, _b2;
_b2 = Symbol.toStringTag, _a2 = serviceCapabilities;
var Noise = class {
  constructor(components, init = {}) {
    ...
    __publicField(this, _b2, "@libp2p/noise");
  ...
  async secureOutbound(connection, options) {
    var _a3, _b3, _c;
    const log = ((_a3 = connection.log) == null ? void 0 : _a3.newScope("noise")) ?? this.log;
    const wrappedConnection = lpStream(connection, {
      lengthEncoder: uint16BEEncode,
      lengthDecoder: uint16BEDecode,
      maxDataLength: NOISE_MSG_MAX_LENGTH_BYTES
    });
    const handshake = await this.performHandshakeInitiator(wrappedConnection, this.components.privateKey, log, (_b3 = options == null ? void 0 : options.remotePeer) == null ? void 0 : _b3.publicKey, options);
    ...
    return {
      ...
      streamMuxer: (options == null ? void 0 : options.skipStreamMuxerNegotiation) === true ? void 0 : this.getStreamMuxer((_c = handshake.payload.extensions) == null ? void 0 : _c.streamMuxers)
    };
  }
  ...
  async secureInbound(connection, options) {
    ...
    const handshake = await this.performHandshakeResponder(wrappedConnection, this.components.privateKey, log, (_b3 = options == null ? void 0 : options.remotePeer) == null ? void 0 : _b3.publicKey, options);
    const publicKey = publicKeyFromProtobuf(handshake.payload.identityKey);
    return {
      connection: toMessageStream(wrappedConnection.unwrap(), handshake, this.metrics),
      remoteExtensions: handshake.payload.extensions,
...
// ../../peercompute/node_modules/@libp2p/noise/dist/src/index.js
function noise(init = {}) {
...
//# sourceMappingURL=@libp2p_noise.js.map
