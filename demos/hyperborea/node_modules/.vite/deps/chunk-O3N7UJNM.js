...
// ../../peercompute/node_modules/netmask/lib/netmask.js
var require_netmask = __commonJS({
  "../../peercompute/node_modules/netmask/lib/netmask.js"(exports) {
    (function() {
...
// ../../peercompute/node_modules/p-defer/index.js
function pDefer() {
  const deferred = {};
...
// ../../peercompute/node_modules/it-pushable/dist/src/fifo.js
var FixedFIFO = class {
  constructor(hwm) {
...
// ../../peercompute/node_modules/it-pushable/dist/src/index.js
...
// ../../peercompute/node_modules/it-queueless-pushable/dist/src/index.js
...
// ../../peercompute/node_modules/it-merge/dist/src/index.js
...
// ../../peercompute/node_modules/it-pipe/dist/src/index.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/errors.js
...
__publicField(UnexpectedEOFError, "name", "UnexpectedEOFError");
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/stream-utils.js
...
function byteStream(stream, opts) {
  const maxBufferSize = (opts == null ? void 0 : opts.maxBufferSize) ?? DEFAULT_MAX_BUFFER_SIZE;
  ...
  const byteStream2 = {
    ...
    async read(options) {
      ...
      while (true) {
        ...
        await raceSignal(hasBytes.promise, options == null ? void 0 : options.signal);
        if (isEOF(stream)) {
...
// ../../peercompute/node_modules/@sindresorhus/fnv1a/index.js
var FNV_PRIMES = {
  32: 16777619n,
  64: 1099511628211n,
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/filters/hashes.js
var fnv1a2 = {
  hash: (input) => {
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/filters/bloom-filter.js
var LN2_SQUARED = Math.LN2 * Math.LN2;

// ../../peercompute/node_modules/@libp2p/utils/dist/src/filters/fingerprint.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/filters/utils.js
function getRandomInt(min, max) {
  return Math.floor(Math.random() * (max - min)) + min;
}

// ../../peercompute/node_modules/@libp2p/utils/dist/src/filters/bucket.js
var Bucket = class {
  constructor(size) {
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/filters/cuckoo-filter.js
...
var CuckooFilter = class {
  ...
  has(item) {
    ...
    const fingerprint = new Fingerprint(item, this.hash, this.seed, this.fingerprintSize);
    const j = this.hash.hash(item, this.seed) % this.filterSize;
    const inJ = ((_a = this.buckets[j]) == null ? void 0 : _a.has(fingerprint)) ?? false;
    if (inJ) {
      return inJ;
    }
    const k = (j ^ fingerprint.hash()) % this.filterSize;
    return ((_b = this.buckets[k]) == null ? void 0 : _b.has(fingerprint)) ?? false;
  }
  remove(item) {
    var _a, _b;
    if (typeof item === "string") {
    ...
    const fingerprint = new Fingerprint(item, this.hash, this.seed, this.fingerprintSize);
    const j = this.hash.hash(item, this.seed) % this.filterSize;
    const inJ = ((_a = this.buckets[j]) == null ? void 0 : _a.remove(fingerprint)) ?? false;
    if (inJ) {
      this.count--;
      return inJ;
    }
    const k = (j ^ fingerprint.hash()) % this.filterSize;
    const inK = ((_b = this.buckets[k]) == null ? void 0 : _b.remove(fingerprint)) ?? false;
    if (inK) {
      this.count--;
    }
    return inK;
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/filters/scalable-cuckoo-filter.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/multiaddr/get-net-config.js
function getNetConfig(ma) {
  var _a, _b, _c, _d, _e, _f;
  const components = ma.getComponents();
  const config = {};
  let index = 0;
  if (((_a = components[index]) == null ? void 0 : _a.name) === "ip6zone") {
  ...
  if (((_b = components[index]) == null ? void 0 : _b.name) === "tcp" || ((_c = components[index]) == null ? void 0 : _c.name) === "udp") {
    config.protocol = components[index].name === "tcp" ? "tcp" : "udp";
    config.port = parseInt(`${components[index].value}`);
    index++;
  }
  if (((_d = components[index]) == null ? void 0 : _d.name) === "ipcidr") {
    if (config.type === "ip4") {
  ...
  if (((_e = components[index]) == null ? void 0 : _e.name) === "tls" && ((_f = components[index + 1]) == null ? void 0 : _f.name) === "sni") {
...
// ../../peercompute/node_modules/@chainsafe/netmask/dist/src/util.js
function allFF(a2, from, to) {
  let i2 = 0;
  for (const e2 of a2) {
    if (i2 < from)
      continue;
...
function deepEqual(a2, b, from, to) {
  let i2 = 0;
  for (const e2 of a2) {
    if (i2 < from)
      continue;
...
// ../../peercompute/node_modules/@chainsafe/netmask/dist/src/ip.js
var IPv4Len = 4;
var IPv6Len = 16;
...
// ../../peercompute/node_modules/@chainsafe/netmask/dist/src/cidr.js
...
// ../../peercompute/node_modules/@chainsafe/netmask/dist/src/ipnet.js
var IpNet = class {
  /**
   *
...
// ../../peercompute/node_modules/@chainsafe/netmask/dist/src/index.js
function cidrContains(cidr, ip) {
  const ipnet = new IpNet(cidr);
  return ipnet.contains(ip);
}

// ../../peercompute/node_modules/@libp2p/utils/dist/src/multiaddr/is-global-unicast.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/multiaddr/is-link-local.js
...
// ../../peercompute/node_modules/is-loopback-addr/dist/src/index.js
function isLoopbackAddr(ip) {
  return /^127\.([0-9]{1,3})\.([0-9]{1,3})\.([0-9]{1,3})$/i.test(ip) || /^::1$/.test(ip);
}

// ../../peercompute/node_modules/@libp2p/utils/dist/src/multiaddr/is-loopback.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/multiaddr/is-network-address.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/private-ip.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/multiaddr/is-private.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/debounce.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/queue/recipient.js
var JobRecipient = class {
  constructor(signal) {
    ...
    (_a = this.signal) == null ? void 0 : _a.addEventListener("abort", this.onAbort);
  }
  onAbort() {
    var _a;
    this.deferred.reject(((_a = this.signal) == null ? void 0 : _a.reason) ?? new AbortError());
  }
  cleanup() {
    var _a;
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/queue/job.js
function randomId() {
...
var Job = class {
  ...
  onAbort() {
    const allAborted = this.recipients.reduce((acc, curr) => {
      var _a;
      return acc && ((_a = curr.signal) == null ? void 0 : _a.aborted) === true;
    }, true);
    if (allAborted) {
  ...
  async join(options = {}) {
    ...
    (_a = options.signal) == null ? void 0 : _a.addEventListener("abort", this.onAbort);
  ...
  cleanup() {
    this.recipients.forEach((recipient) => {
      var _a;
      recipient.cleanup();
      (_a = recipient.signal) == null ? void 0 : _a.removeEventListener("abort", this.onAbort);
    });
  }
};

// ../../peercompute/node_modules/@libp2p/utils/dist/src/queue/index.js
var Queue = class extends TypedEventEmitter {
  constructor(init = {}) {
    ...
    if (init.metricName != null) {
      (_a = init.metrics) == null ? void 0 : _a.registerMetricGroup(init.metricName, {
        calculate: () => {
          return {
  ...
  async *toGenerator(options) {
    ...
    (_b = options == null ? void 0 : options.signal) == null ? void 0 : _b.addEventListener("abort", onSignalAbort);
    try {
      yield* stream;
    } finally {
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/abstract-message-stream.js
...
var AbstractMessageStream = class extends TypedEventEmitter {
  constructor(init) {
    ...
    const continueSendingOnDrain = () => {
      ...
      (_a = this.onDrainPromise) == null ? void 0 : _a.resolve();
    };
    this.addEventListener("drain", continueSendingOnDrain);
    const rejectOnDrainOnClose = (evt) => {
      var _a;
      (_a = this.onDrainPromise) == null ? void 0 : _a.reject(evt.error ?? new StreamClosedError());
    };
  ...
  async onDrain(options) {
    ...
    return raceSignal(this.onDrainPromise.promise, options == null ? void 0 : options.signal);
  }
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/abstract-multiaddr-connection.js
var AbstractMultiaddrConnection = class extends AbstractMessageStream {
  constructor(init) {
    ...
    this.addEventListener("close", (evt) => {
      var _a, _b, _c, _d, _e;
      (_a = this.metrics) == null ? void 0 : _a.increment({ [`${this.metricPrefix}end`]: true });
      if (evt.error != null) {
        if (evt.local) {
          (_b = this.metrics) == null ? void 0 : _b.increment({ [`${this.metricPrefix}abort`]: true });
        } else {
          (_c = this.metrics) == null ? void 0 : _c.increment({ [`${this.metricPrefix}reset`]: true });
        }
      } else {
        if (evt.local) {
          (_d = this.metrics) == null ? void 0 : _d.increment({ [`${this.metricPrefix}_local_close`]: true });
        } else {
          (_e = this.metrics) == null ? void 0 : _e.increment({ [`${this.metricPrefix}_remote_close`]: true });
        }
      }
    });
  }
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/is-promise.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/abstract-stream-muxer.js
var AbstractStreamMuxer = class extends TypedEventEmitter {
  ...
  cleanUpStream(stream) {
    ...
    const muxerOnStreamEnd = (evt) => {
      ...
      if (evt.error != null) {
        if (evt.local) {
          (_a2 = this.metrics) == null ? void 0 : _a2.increment({ [`${stream.direction}_stream_reset`]: true });
        } else {
          (_b = this.metrics) == null ? void 0 : _b.increment({ [`${stream.direction}_stream_abort`]: true });
        }
      } else {
        (_c = this.metrics) == null ? void 0 : _c.increment({ [`${stream.direction}_stream_end`]: true });
      }
    };
    stream.addEventListener("close", muxerOnStreamEnd);
    (_a = this.metrics) == null ? void 0 : _a.increment({ [`${stream.direction}_stream`]: true });
  }
  addEventListener(...args) {
    super.addEventListener.apply(this, args);
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/abstract-stream.js
...
// ../../peercompute/node_modules/any-signal/dist/src/index.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/moving-average.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/adaptive-timeout.js
...
var AdaptiveTimeout = class {
  constructor(init = {}) {
    ...
    if (init.metricName != null) {
      this.metric = (_a = init.metrics) == null ? void 0 : _a.registerMetricGroup(init.metricName);
    }
  }
  ...
  cleanUp(signal) {
    ...
    if (signal.aborted) {
      ...
      (_a = this.metric) == null ? void 0 : _a.update({
      ...
      this.next.push(time);
      (_b = this.metric) == null ? void 0 : _b.update({
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/length-prefixed-decoder.js
...
var LengthPrefixedDecoder = class {
  constructor(init = {}) {
    ...
    this.lengthDecoder = init.lengthDecoder ?? decode;
...
// ../../peercompute/node_modules/cborg/lib/is.js
var typeofs = [
  "string",
  "number",
  "bigint",
...
// ../../peercompute/node_modules/cborg/lib/token.js
var Type = class {
  /**
   * @param {number} major
   * @param {string} name
...
// ../../peercompute/node_modules/cborg/lib/byte-utils.js
...
// ../../peercompute/node_modules/cborg/lib/bl.js
...
// ../../peercompute/node_modules/cborg/lib/common.js
...
// ../../peercompute/node_modules/cborg/lib/0uint.js
...
// ../../peercompute/node_modules/cborg/lib/1negint.js
...
// ../../peercompute/node_modules/cborg/lib/2bytes.js
...
// ../../peercompute/node_modules/cborg/lib/3string.js
...
// ../../peercompute/node_modules/cborg/lib/4array.js
...
// ../../peercompute/node_modules/cborg/lib/5map.js
...
// ../../peercompute/node_modules/cborg/lib/6tag.js
...
// ../../peercompute/node_modules/cborg/lib/7float.js
var MINOR_FALSE = 20;
var MINOR_TRUE = 21;
var MINOR_NULL = 22;
...
// ../../peercompute/node_modules/cborg/lib/jump.js
...
// ../../peercompute/node_modules/cborg/lib/encode.js
...
// ../../peercompute/node_modules/cborg/lib/decode.js
var DONE = Symbol.for("DONE");
var BREAK = Symbol.for("BREAK");

// ../../peercompute/node_modules/@libp2p/utils/node_modules/it-length-prefixed/dist/src/constants.js
var MAX_LENGTH_LENGTH = 8;
var MAX_DATA_LENGTH = 1024 * 1024 * 4;

// ../../peercompute/node_modules/@libp2p/utils/node_modules/it-length-prefixed/dist/src/errors.js
...
// ../../peercompute/node_modules/@libp2p/utils/node_modules/it-length-prefixed/dist/src/utils.js
function isAsyncIterable3(thing) {
  return thing[Symbol.asyncIterator] != null;
}

// ../../peercompute/node_modules/@libp2p/utils/node_modules/it-length-prefixed/dist/src/encode.js
...
function encode3(source, options) {
  options = options ?? {};
...
// ../../peercompute/node_modules/@libp2p/utils/node_modules/it-length-prefixed/dist/src/decode.js
var ReadMode;
(function(ReadMode2) {
...
decode3.fromReader = (reader, options) => {
  let byteLength = 1;
  ...
  return decode3(varByteSource, {
    ...options ?? {},
    onLength
  });
};

// ../../peercompute/node_modules/weald/node_modules/ms/dist/index.js
var e = 1e3;
var t = e * 60;
var n = t * 60;
var r = n * 24;
...
// ../../peercompute/node_modules/weald/dist/src/common.js
function setup(env) {
...
// ../../peercompute/node_modules/weald/dist/src/browser.js
...
function useColors() {
  ...
  if (typeof navigator !== "undefined" && ((_a = navigator.userAgent) == null ? void 0 : _a.toLowerCase().match(/(edge|trident)\/(\d+)/)) != null) {
    return false;
  }
  return typeof document !== "undefined" && ((_c = (_b = document.documentElement) == null ? void 0 : _b.style) == null ? void 0 : _c.WebkitAppearance) || // Is firebug? http://stackoverflow.com/a/398120/376773
...
// ../../peercompute/node_modules/weald/dist/src/index.js
var src_default2 = browser_default;

// ../../peercompute/node_modules/@libp2p/logger/dist/src/index.js
...
function isAggregateError(err) {
  return err instanceof AggregateError || (err == null ? void 0 : err.name) === "AggregateError" && Array.isArray(err.errors);
}
...
function logger(name, options) {
  ...
  if (src_default2.enabled(`${name}:trace`) && src_default2.names.map((r2) => r2.toString()).find((n2) => n2.includes(":trace")) != null) {
    trace = src_default2(`${name}:trace`, options);
  }
  return Object.assign(src_default2(name, options), {
    error: src_default2(`${name}:error`, options),
    trace,
...
// ../../peercompute/node_modules/unlimited-timeout/index.js
var MAX_TIMEOUT = 2147483647;
var brandSymbol = Symbol.for("sindresorhus/unlimited-timeout#brand");
function setTimeout2(callback, delay2, ...arguments_) {
  ...
  const timeout = {
    ...
    ref() {
      var _a, _b;
      shouldUnref = false;
      (_b = (_a = timeout.id) == null ? void 0 : _a.ref) == null ? void 0 : _b.call(_a);
      return timeout;
    },
    unref() {
      var _a, _b;
      shouldUnref = true;
      (_b = (_a = timeout.id) == null ? void 0 : _a.unref) == null ? void 0 : _b.call(_a);
      return timeout;
    }
  };
  ...
  const schedule = (remainingDelay) => {
    ...
    if (remainingDelay <= MAX_TIMEOUT) {
      ...
      if (shouldUnref) {
        (_d = (_c = timeout.id) == null ? void 0 : _c.unref) == null ? void 0 : _d.call(_c);
      }
    }
  };
  schedule(delay2);
...
// ../../peercompute/node_modules/delay/index.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/message-queue.js
var DEFAULT_CHUNK_SIZE = 1024 * 64;

// ../../peercompute/node_modules/@libp2p/utils/dist/src/peer-queue.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/priority-queue.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/rate-limiter.js
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/repeating-task.js
function repeatingTask(fn, interval, options) {
  ...
  const runTaskDebounced = debounce(runTask, (options == null ? void 0 : options.debounce) ?? 100);
  let started = false;
  return {
    setInterval: (ms) => {
      if (interval === ms) {
...
// ../../peercompute/node_modules/@libp2p/utils/dist/src/tracked-map.js
...
//# sourceMappingURL=chunk-O3N7UJNM.js.map
