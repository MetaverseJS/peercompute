    ...
    if (char === "/" || ended) {
      ...
      if (collecting === "protocol") {
        ...
        if (codec.size != null && codec.size !== 0) {
          ...
          component.value = ((_a2 = codec.stringToValue) == null ? void 0 : _a2.call(codec, value)) ?? value;
        }
        components.push(component);
        value = "";
        protocol = "";
...
var _a, _components, _string, _bytes;
var _Multiaddr = class _Multiaddr {
  ...
  decapsulateCode(code) {
    ...
    for (let i = __privateGet(this, _components).length - 1; i > -1; i--) {
      if (__privateGet(this, _components)[i].code === code) {
        index = i;
        break;
      }
    }
...
//# sourceMappingURL=chunk-SAZZGDH5.js.map
