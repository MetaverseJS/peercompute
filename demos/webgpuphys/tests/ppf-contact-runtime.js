// Headless runtime smoke test for ppf-contact-solver demo.
// Serves demos/ and loads /demos/ppf-contact-solver.html
...
const PORT = 4183;
const URL = `http://localhost:${PORT}/demos/ppf-contact-solver.html`;
...
async function main() {
  ...
  if (adapterErrors.length) {
    ...
    console.log("PPF contact solver runtime smoke test passed");
  }
